...
namespace NugetConsolidate.Service
{
	...
	{
		public const string PROJECT_FILE_PROPS_FILE_NAME = "GeneratedPackageIncludes.Build.props";
		...
		private XDocument CreateOrOpenBuildPropsFile(string path)
		{
			...
			var result = new XDocument(new XComment("this file was auto generated by a tool"),
